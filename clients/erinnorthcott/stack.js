...
(function () {
  ...
  /* phones and short windows read as a plain column: the pinned deck lagged on
     her phone (2026-09-10), so the stack is desktop only */
  const wide = window.matchMedia('(min-width: 821px) and (min-height: 700px)');
